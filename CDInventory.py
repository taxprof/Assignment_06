...
# TDavis, Mar 2022, Modified for Assignment
#------------------------------------------#
...
class DataProcessor:
    ...
    def create_entry(lstRow):
        
        """Allows the user to create an entry"
       
        Args: lstRow: list of inventory entry/one data line
    ...
    def delete_entry(lstTbl, intIDDel):
        """Allows the user to delete an entry
        
        Args: lstTbl:list of dictionary rows (i.e. full inventory in current memory)"
...
class IO:
    ...
    @staticmethod
    def get_entry(strID, strTitle, stArtist):
        
        """Collects data from the user for an entr
        
        Args: 
            strID: the id number for the entry
            strTitle: the title for the entry
            stArtist: the artist name for the entry
    
        Returns:
            lstRow: a list that will be converted to a dicRow and added to the lstTbl in another function"""
            
        strID = input('Enter ID: ').strip()
        strTitle = input('What is the CD\'s title? ').strip()
        stArtist = input('What is the Artist\'s name? ').strip()
        lstRow=[strID, strTitle, stArtist]
        return lstRow
